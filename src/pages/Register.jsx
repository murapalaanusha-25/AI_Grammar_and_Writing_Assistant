...
import { PenLine, Mail, Lock, User, AlertCircle, ArrowRight, CheckCircle } from "lucide-react";
...
export default function Register() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a0c", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'DM Sans', sans-serif", padding: "24px", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "fixed", top: "-20%", right: "-10%", width: 600, height: 600, borderRadius: "50%", background: "radial-gradient(circle, rgba(200,240,74,0.06) 0%, transparent 68%)", pointerEvents: "none" }} />

      <div style={{ position: "relative", zIndex: 1, width: "100%", maxWidth: 440, animation: "fadeUp 0.4s cubic-bezier(0.4,0,0.2,1)" }}>
        <div style={{ textAlign: "center", marginBottom: 36 }}>
          ...
          <h1 style={{ fontSize: 26, fontWeight: 800, color: "#fff", margin: "0 0 6px", letterSpacing: -0.8 }}>Create account</h1>
          <p style={{ fontSize: 14, color: "rgba(255,255,255,0.35)", margin: 0 }}>Start writing better today</p>
        </div>
        ...
        <div style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.09)", borderRadius: 20, padding: 32 }}>
          {success ? (
            <div style={{ textAlign: "center", padding: "20px 0" }}>
              ...
              <p style={{ fontSize: 14, color: "rgba(255,255,255,0.45)", margin: "0 0 20px", lineHeight: 1.6 }}>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                <div>
                  <label style={{ fontSize: 12, fontWeight: 600, color: "rgba(255,255,255,0.5)", letterSpacing: 0.5, display: "block", marginBottom: 7 }}>Full name</label>
                  <div style={{ position: "relative" }}>
                    <User size={15} color="rgba(255,255,255,0.25)" style={{ position: "absolute", left: 13, top: "50%", transform: "translateY(-50%)", pointerEvents: "none" }} />
                ...
                <div>
                  <label style={{ fontSize: 12, fontWeight: 600, color: "rgba(255,255,255,0.5)", letterSpacing: 0.5, display: "block", marginBottom: 7 }}>Password</label>
                  <div style={{ position: "relative" }}>
                ...
                <div>
                  <label style={{ fontSize: 12, fontWeight: 600, color: "rgba(255,255,255,0.5)", letterSpacing: 0.5, display: "block", marginBottom: 7 }}>Confirm password</label>
                  <div style={{ position: "relative" }}>
                    <Lock size={15} color="rgba(255,255,255,0.25)" style={{ position: "absolute", left: 13, top: "50%", transform: "translateY(-50%)", pointerEvents: "none" }} />
                ...
                <button className="submit-btn" type="submit" disabled={loading}
                  style={{ marginTop: 6, padding: "13px", borderRadius: 12, border: "none", background: loading ? "rgba(200,240,74,0.2)" : "linear-gradient(135deg, #c8f04a, #8ee04a)", color: loading ? "rgba(255,255,255,0.3)" : "#0a0a0c", fontWeight: 700, fontSize: 14, cursor: loading ? "not-allowed" : "pointer", fontFamily: "'DM Sans', sans-serif", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, transition: "all 0.2s", boxShadow: "0 4px 20px rgba(200,240,74,0.15)" }}>
                  {loading
                    ? <><div style={{ width: 16, height: 16, border: "2px solid rgba(0,0,0,0.2)", borderTopColor: "#0a0a0c", borderRadius: "50%", animation: "spin 0.7s linear infinite" }} />Creating account...</>
                    : <><ArrowRight size={15} strokeWidth={2.5} />Create account</>}
                </button>
              </form>
            </>
          )}
